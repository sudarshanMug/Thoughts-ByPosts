...
function ProfileFollowers(props) {
  ...
  return (
    <div className="list-group">
      ...
      {posts.length === 0 && appState.users.username === username && <p className="lead text-muted text-center">You don&rsquo;t have any followers yet.</p>}
      {posts.length === 0 && appState.users.username !== username && (
